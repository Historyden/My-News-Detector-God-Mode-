...
<style>
    ...
    * { font-family: 'Inter', sans-serif; }
    ...
    .css-1d391kg { background: rgba(255, 255, 255, 0.95); backdrop-filter: blur(10px); }
...
# -----------------------------
st.markdown("---")
st.markdown("<p style='text-align: center; color: white; opacity: 0.7;'>Made with ❤️ by Jaivardhan • Powered by Machine Learning and AI</p>", unsafe_allow_html=True)import os
import pickle
import random
import time
import streamlit as st
